...
corpus2matrix <- function(corpus,ngram=0,fname='1',use.dict=T,lo.bound=0.03,hi.bound=0.5) {
...
run.nmf <- function(mat,ks=2:6,k=0) {
  ...
  if (k==0) { ## estimate best rank (k)
    ...
    dim(mat2)
    dim(mat1)
    #mat3 <- as.matrix((mat2 > 0) + 0)
    #mat3
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 81152)  
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 84142)
    summary(estim.r)  
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 23912)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 61898)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 98092)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 16491)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 98722)    
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 81153)  
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 84143)
    summary(estim.r)  
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 23913)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 61899)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 98093)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 16492)
    summary(estim.r)
    estim.r <- nmf(mat2, 2:10, nrun = 1, seed = 98723)    
    summary(estim.r)
    #options( java.parameters = "-Xmx2048m" )
    #estim.ra = nmf(mat3, 3, nrun = 1, seed = 123, .options='verbose=TRUE, keep.all=TRUE, debug=TRUE, shared.memory=TRUE')    
    estim.ra = nmf(mat3, 2:10, nrun = 1, seed = 125)
    plot(estim.r)
    summary(estim.ra)
  } 
  if (0) {
...
if (0) {
 ...
 mat = load.data.in.range(start.date="2013-10-01",end.date="2013-10-15",use.cache=F)
 for (ki in 8:10) run.nmf( as.matrix(mat) ,ks=ki,k=0)
run.nmf( as.matrix(mat) ,ks=2:3,k=0)
